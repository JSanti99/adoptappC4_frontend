    ...
    <div class="container_signUp_user">
        ...
        <ul id="ula">
          ...
          <il>
            <div id="textotorgante">
              Registra tus datos personales, de ser requerido te contactaremos
              para confirmar tus datos y continuar el proceso de adopción.
            </div>
          </il>
        </ul>
      </div>
      ...
      >
        ...
        <input
          ...
          placeholder="Nomenclatura en Mayúscula y #"
        />
        ...
        <input
          ...
          placeholder="Si no tiene indique Celular"
        />
        ...
        <input
          ...
          placeholder="Si no tiene indique fijo"
        />
        ...
        <input
          ...
          id="email"
          v-model="user.email"
          placeholder="Ejem: afandinho@elmail.com"
        />
  ...
  methods: {
    processSignUp: async function() {
      ...
      await this.$apollo
        ...
        .then((result) => {
          let dataLogIn = {
            id_user: jwt_decode(result.data.signUpUser.access)?.user_id,
